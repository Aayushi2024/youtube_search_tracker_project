...
<head>
  ...
  <title>Youtube Search Tracker - Login</title>
  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="index.php" method="post" class="sign-in-form">
          ...
          <button type="submit" name="loginButton" value="true" class="btn solid">Login</button>
        </form>
        <form action="index.php" method="post" class="sign-up-form">
          ...
          <button type="submit" name="registerButton" value="true" class="btn solid">Register</button>
        </form>
      </div>
    </div>
    <div class="panels-container">
      ...
      <div class="panel right-panel">
        <div class="content">
          <h1>Youtube Search Tracker</h1>
          <h3 class="see">One of us?</h3>
          <button class="btn transparent see" id="sign-in-btn">Sign In</button>
        </div>
